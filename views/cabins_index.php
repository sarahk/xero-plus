<table class='table table-striped table-bordered' id='getCabinsTable' style='width:100%'>"
  <thead><tr>
    <th>#</th>
    <th>Style</th>
    <th>Status</th>
...
<!-- Modal -->
<div class='modal fade' id='cabinSingle' tabindex='-1' role='dialog' aria-labelledby='cabinSingleLabel' aria-hidden='true'>
  <div class='modal-dialog modal-dialog-centered' role='document'>
    <div class='modal-content'>
        ...
        <div class='container'>
          <form type='GET' id='modalForm'>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="cabinnumber" aria-describedby="cabinnumberHelp" placeholder="Enter the new cabin's number">
            </div>
            ...
            <div class="form-group">
              <label for="paintgrey">Painted Grey</label>

              <select name='paintgrey' id='paintgrey' class="form-control">
                <option value=''>---</option>
      ...
      <div class='modal-footer'>
        <div class="spinner-grow text-warning" role="status" id='modalSpinner' style='display: none; font-size: 2em;padding: 1em;'>
