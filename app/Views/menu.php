...
<ul>
    ...
    <li><a href="authorizedResource.php?action=9">Get Invoices</a></li>
    ...
    <li><a href="vehicleLog.php?action=1">Vehicle Log</a></li>
    <li><a href="vehicleLog.php?action=2">Add Trip</a></li>
</ul>
